...
class BindPhoneViewController: UIViewController {
    ...
    func setupViews() {
        title = localizeStrings("BindPhone")
    ...
    func onConfirm() {
        ...
        let request = BindingPhoneRequest(phone: account, code: code)
    ...
    lazy var authView = AccountCodeAuthView(staticAccountType: .phone)
}
